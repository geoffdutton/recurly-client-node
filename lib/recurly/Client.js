...
class Client extends BaseClient {
   ...
   *   **Note:** this value is an ISO8601 timestamp. A partial timestamp that does not include a time zone will default to UTC.
   *
   * @param {string} params.subscriber - Filter accounts with or without a subscription in the `active`,
   ...
   * @example
   * try {
   *   const result = await client.removeLineItem(lineItemId + "asdasd")
   ...
   *
   * API docs: {@link https://partner-docs.recurly.com/v2018-08-09#operation/create_purchase}
   *
   * @example
   * try {
   *   let purchaseReq = {
   ...
   *
   * API docs: {@link https://partner-docs.recurly.com/v2018-08-09#operation/preview_purchase}
   *
   * @example
   * try {
   *   let purchaseReq = {
